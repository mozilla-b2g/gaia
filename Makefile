...
$(1)$(SEP)test$(SEP)unit$(SEP)_sandbox.html $(1)$(SEP)test$(SEP)unit$(SEP)_proxy.html: $(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_proxy.html $(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_sandbox.html
	...
	rsync $(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_proxy.html $(1)$(SEP)test$(SEP)unit$(SEP)_proxy.html; \
	rsync $(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_sandbox.html $(1)$(SEP)test$(SEP)unit$(SEP)_sandbox.html;
endef
