...
modules.tar: gaia_node_modules.revision
	...
	-$(DOWNLOAD_CMD) https://github.com/julienw/gaia-node-modules/tarball/$(NODE_MODULES_REV) &&\
...
ifeq "$(NODE_MODULES_SRC)" "modules.tar"
	$(TAR_WILDCARDS) --strip-components 1 -x -m -f $(NODE_MODULES_SRC) "julienw-gaia-node-modules-*/node_modules"
else
	rm -fr node_modules
