...
$(1)$(SEP)test$(SEP)unit$(SEP)_sandbox.html $(1)$(SEP)test$(SEP)unit$(SEP)_proxy.html: $(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_proxy.html $(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_sandbox.html
	...
	@echo "Copying _proxy.html and _sandbox.html for `basename $(1)`"
	@$(call atomic-copy,$(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_proxy.html,$(1)$(SEP)test$(SEP)unit$(SEP)_proxy.html);
	@$(call atomic-copy,$(TEST_COMMON)$(SEP)test$(SEP)boilerplate$(SEP)_sandbox.html,$(1)$(SEP)test$(SEP)unit$(SEP)_sandbox.html);
endef
