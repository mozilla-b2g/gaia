...
(function(exports) {
  /**
   * LandingAppWindow creates a instance of homescreen by give manifestURL.
   *
   * ##### Flow chart
   ...
   * @event LandingAppWindow#homescreencreated
   */
  /**
   * Fired when the homescreen window is removed.
   * @event LandingAppWindow#homescreenterminated
   */
  /**
   * Fired when the homescreen window is opening.
   * @event LandingAppWindow#homescreenopening
   */
  /**
   * Fired when the homescreen window is opened.
   * @event LandingAppWindow#homescreenopen
   */
  /**
   * Fired when the homescreen window is closed.
   * @event LandingAppWindow#homescreenclosed
   */
  /**
   * Fired when the homescreen window is closing.
   * @event LandingAppWindow#homescreenclosing
   */
  /**
   * Fired when the homescreen window is closed.
   * @event LandingAppWindow#homescreenclose
   */
  /**
   * Fired before the homescreen window is rendered.
   * @event LandingAppWindow#homescreenwillrender
   */
  /**
   * Fired when the homescreen window is rendered to the DOM tree.
   * @event LandingAppWindow#homescreenrendered
   */
  /**
   * Fired when the page visibility of the homescreen window is
   * changed to foreground.
   * @event LandingAppWindow#homescreenforeground
   */
  /**
   * Fired when the page visibility of the homescreen window is
   * changed to background.
   * @event LandingAppWindow#homescreenbackground
   */

  LandingAppWindow.prototype = Object.create(AppWindow.prototype);

  LandingAppWindow.prototype._DEBUG = false;
  ...
  LandingAppWindow.prototype._handle__opening = function hw__handle__opening() {
    this.ensure();
  };

  LandingAppWindow.prototype._handle_mozbrowserclose =
    function hw__handle_mozbrowserclose(evt) {
      this.restart();
    };

  LandingAppWindow.prototype._handle_mozbrowsererror =
  ...
  LandingAppWindow.prototype.restart = function hw_restart() {
  ...
  *
  */
  LandingAppWindow.prototype.resize = function aw_resize() {
   ...
   *
   * this {LandingAppWindow}
   * memberof LandingAppWindow
   */
  LandingAppWindow.prototype.hideFadeOverlay = function hw_hideFadeOverlay() {
   ...
   * memberof LandingAppWindow
   */
  LandingAppWindow.prototype.showFadeOverlay = function hw_showFadeOverlay() {
