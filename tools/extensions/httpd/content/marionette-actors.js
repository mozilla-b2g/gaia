...
loader.loadSubScript("chrome://httpd.js/content/marionette-simpletest.js");
loader.loadSubScript("chrome://httpd.js/content/marionette-log-obj.js");
Cu.import("chrome://httpd.js/content/marionette-elements.js");
...
MarionetteDriverActor.prototype = {
  ...
  startBrowser: function MDA_startBrowser(win, newSession) {
    ...
    this.curBrowser.loadFrameScript("chrome://httpd.js/content/marionette-listener.js", win);
  },
  ...
  deleteSession: function MDA_deleteSession() {
    if (this.curBrowser != null) {
      ...
      while (winEnum.hasMoreElements()) {
        winEnum.getNext().messageManager.removeDelayedFrameScript("chrome://httpd.js/content/marionette-listener.js"); 
      }
    }
    this.sendOk();
