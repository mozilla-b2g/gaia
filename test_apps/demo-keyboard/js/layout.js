...
(function(exports) {
   ...
   * command has an associated keycode property, for example, and the
   * "switchpage" command has a "page" property.
   *
  ...
  KeyboardLayout.prototype.getPageView =
    function(container, pagename, variant) {
      if (!pagename) {
      ...
      if (!pageview) {
        ...
        // Resize in case the orientation has changed since we were last
        // displayed.
