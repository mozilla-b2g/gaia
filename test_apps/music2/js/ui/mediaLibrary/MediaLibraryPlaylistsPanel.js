...
var MediaLibraryPlaylistsPanel =
  function(playlists, currentPlaylist, currentPlaylistId) {
    ...
    if (numPlaylists === 0) {
      ...
      Utils.select(options, function(choice) {
        ...
        if (choice === '__cancel') {
          ...
          var text = 'copy of ' + this.currentPlaylists[choice].title;
          title = prompt('Playlist Name:', text);
          if (title !== null && title !== '')
