var SeekBar = function() {
  ...
  this.dom.playerSeek.addEventListener('touchstart', this.touchstart.bind(this));
...
SeekBar.prototype = {
  ...
  touchmove: function(e) {
    ...
    var percent =
      (x - this.dom.playerSeekBar.offsetLeft) / this.dom.playerSeekBarProgress.offsetWidth;
  ...
  rerender: function() {
    ...
    if (!window.isNaN(x)) {
      this.dom.playerSeekBarIndicator.style.transform = 'translateX(' + x + 'px)';
    }
  },
