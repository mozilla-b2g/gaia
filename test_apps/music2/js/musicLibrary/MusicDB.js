var MusicDB = function(){
  ...
  this.mediaDB = new MediaDB('music', parseAudioMetadata, {
    indexes: ['metadata.album', 'metadata.artist', 'metadata.title', 'metadata.genre',
              'metadata.played', 'date', 'metadata.favorited'],
    batchSize: 1,
...
MusicDB.prototype = {
  ...
  getFavorited: function(done){
    ...
    this.getWithFilter('metadata.title', null, { favorited: true }, done, disableCache);

    //this.mediaDB.enumerateAll('metadata.favorited', null, 'next', function(items){
