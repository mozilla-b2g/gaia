var Utils = {
  ...
  onButtonTap: function(div, fn, module){
    ...
    tapManager.router.when('down', function buttonDown(){ div.classList.add('buttonDown'); }, { 'module': this });
    tapManager.router.when('up', function buttonUp(){ div.classList.remove('buttonDown'); }, { 'module': this });
    return tapManager;
  },
  onButtonLongTap: function(div, ontap, onlongTap, module){
    ...
    tapManager.router.when('down', function buttonDown(){ div.classList.add('buttonDown'); }, { 'module': this });
    tapManager.router.when('up', function buttonUp(){ div.classList.remove('buttonDown'); div.classList.remove('buttonLong'); }, { 'module': this });
    tapManager.router.when('long', function buttonLong(){ div.classList.remove('buttonDown'); div.classList.add('buttonLong'); }, { 'module': this });
