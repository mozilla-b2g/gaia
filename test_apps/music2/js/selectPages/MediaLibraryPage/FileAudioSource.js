...
FileAudioSource.prototype = {
  ...
  setInfo: function(infoDiv){
    ...
    titleDiv.innerHTML = this.song.metadata.title;
    albumDiv.innerHTML = this.song.metadata.album;
    artistDiv.innerHTML = this.song.metadata.artist;
    infoDiv.appendChild(titleDiv);
    infoDiv.appendChild(albumDiv);
    infoDiv.appendChild(artistDiv);
  },
  setAlbumArt: function(img){
    this.musicDB.getAlbumArtAsURL(this.song, function(url){
      img.src = url;
    });
  },
