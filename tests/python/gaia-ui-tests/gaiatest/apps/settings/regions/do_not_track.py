...
class DoNotTrack(Base):
    ...
    _allow_tracking_checkbox_locator = (By.XPATH, '//li/p[@data-l10n-id="allowTracking"]')
    _disallow_tracking_checkbox_locator = (By.XPATH, '//li/p[@data-l10n-id="doNotTrackActions"]')
    _do_not_have_pref_on_tracking_checkbox_locator = (By.XPATH, '//li/p[@data-l10n-id="doNotHavePrefOnTracking"]')
