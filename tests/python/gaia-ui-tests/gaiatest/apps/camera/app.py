...
class Camera(Base):
    ...
    _switch_to_gallery_button_locator = (By.ID, 'gallery-button')
    ...
    def is_filmstrip_image_displayed(self):
        # Wait for filmstrip
        self.wait_for_element_displayed(*self._filmstrip_image_locator)
        return self.marionette.find_element(*self._filmstrip_image_locator).is_displayed()
