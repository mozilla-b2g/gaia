...
class MarketplaceDev(Base):
    ...
    def __init__(self, marionette, app_name=None, manifest_url=None):
    ...
    def search(self, term):
        ...
        self.wait_for_element_present(*self._loading_fragment_locator)
        self.wait_for_element_displayed(*self._loading_fragment_locator)
...
class Result(PageRegion):
    ...
    _install_spinner_locator = (By.CSS_SELECTOR, '.button.product.install.spinning')
