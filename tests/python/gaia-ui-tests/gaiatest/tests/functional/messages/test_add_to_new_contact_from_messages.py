...
class TestSmsCreateContact(GaiaTestCase):
    ...
    def setUp(self):
        ...
        self.data_layer.send_sms(self.device.phone_numbers[0], _text_message_content)
    ...
    def test_sms_create_new_contact(self):
        ...
        self.assertEqual(self.message_thread.header_text, self.device.phone_numbers[0])
        ...
        self.assertEqual(contact_details.phone_numbers[0], self.device.phone_numbers[0])
