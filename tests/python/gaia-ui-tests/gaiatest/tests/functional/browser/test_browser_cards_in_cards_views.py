...
class TestBrowserCardsInCardsView(GaiaTestCase):
    ...
    def test_browser_cards_in_cards_views(self):
        ...
        search2 = browser.open_new_window()
        search2.wait_to_be_displayed()
        browser2 = search2.go_to_url(self.test_url2)
