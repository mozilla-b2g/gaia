...
class TestSettingsRTLPS(GaiaImageCompareTestCase):
    ...
    def test_settings_app(self):
        ...
        privacycontrol_page.return_to_prev_menu2(privacycontrol_page.screen_element, privacycontrol_page.about_screen_element)
        ...
        privacycontrol_page.return_to_prev_menu2(loc_acc_page.applist_screen_element, loc_acc_page.appview_screen_element)
        privacycontrol_page.return_to_prev_menu2(loc_acc_page.screen_element, loc_acc_page.applist_screen_element)
        privacycontrol_page.return_to_prev_menu2(privacycontrol_page.screen_element, loc_acc_page.screen_element)

        ################# Remote Protect #################
        rprotect_page = privacycontrol_page.tap_remote_protect()
        self.take_screenshot('privacy_control-remprotect')
        privacycontrol_page.return_to_prev_menu2(privacycontrol_page.screen_element, rprotect_page.screen_element)
        ...
        privacycontrol_page.return_to_prev_menu2(transpc_page.perm_screen_element, transpc_page.perm_detail_element)
