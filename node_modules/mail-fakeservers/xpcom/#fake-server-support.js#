...
console.log('----> responseData:::', responseData);
  ...
  _pop3_backdoor_addMessagesToFolder: function(pop3Daemon, req, pop3Handler) {
    pop3Daemon.setMessages(
      pop3Daemon._messages.concat(req.messages).map(function(msg) {
        if (msg.fileData) {
          return msg;
        } else {
  ...
  _pop3_backdoor_removeMessagesFromFolder: function(pop3Daemon, req, pop3Handler) {
    pop3Daemon.setMessages(
      pop3Daemon._messages.filter(function(msg) {
        return msg.
      });
    );
    // return the total number of messages in the folder now
