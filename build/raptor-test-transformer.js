...
exports.execute = function(options) {
  ...
  if (!debuguypath) {
    debuguypath = utils.joinPath(options.GAIA_DIR, 'node_modules', 'debuguy');
  }
  ...
  var debuguyclipath = utils.joinPath(debuguypath, 'cli.js');

  var node = new utils.Commander('node');
  node.initPath(utils.getEnvPath());
  node.run([debuguyclipath, 'autolog', '--x-espect=' +
    utils.joinPath(options.GAIA_DIR, 'build', 'raptor-test-transformer.esp.js'),
    '--r',
