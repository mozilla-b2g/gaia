...
PreferencesBuilder.prototype.preparePref = function() {
  ...
  if (this.config.LOCAL_DOMAINS) {
    this.editLocalDomainPref();
  }
  if (this.config.DESKTOP) {
    this.editDesktopPref();
  }
  if (this.config.DEBUG) {
    this.editDEBUGPref();
  }
  if (this.config.DEVICE_DEBUG) {
    this.editDeviceDebugPref();
  }
};

PreferencesBuilder.prototype.editLocalDomainPref = function() {
  this.prefs['network.dns.localDomains'] = this.domains.join(',');
};

PreferencesBuilder.prototype.editDesktopPref = function() {
...
PreferencesBuilder.prototype.editDEBUGPref = function() {
...
PreferencesBuilder.prototype.editDeviceDebugPref = function() {
