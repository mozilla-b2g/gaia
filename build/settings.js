...
var settings = [
 ...
 new Setting("costcontrol.fte", true),
 new Setting("costcontrol.plantype", "prepaid"),
 new Setting("costcontrol.billingcycle", "monthly"),
 new Setting("costcontrol.credit.format", "R$ &i,&d"),
 new Setting("costcontrol.credit.lowlimit", 4),
 new Setting("costcontrol.balance.destination", "8000"),
 new Setting("costcontrol.balance.text", ""),
 ...
 new Setting("costcontrol.topup.senders", "1515"),
 new Setting("costcontrol.topup.regexp", "R\\$\\s+([0-9]+)(?:[,\\.]([0-9]+))?"),
