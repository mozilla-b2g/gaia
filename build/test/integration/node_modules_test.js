...
suite('Node modules tests [Network Required]', function() {
  ...
  test('make node_modules from git mirror', function(done) {
    ...
    var url = 'https://git.mozilla.org/b2g/gaia-node-modules.git';
    helper.exec('NODE_MODULES_GIT_URL=' + url + ' make node_modules',
