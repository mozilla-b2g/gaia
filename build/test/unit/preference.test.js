...
suite('preferences.js', function() {
  ...
  suite('editLocalDomainPref, editDesktopPref, editDEBUGPref, ' +
    ...
    test('editLocalDomainPref', function () {
      ...
      preferences.prefs = {};
      preferences.editLocalDomainPref();
    ...
    test('editDeviceDebugPref', function () {
      preferences.prefs = {};
      preferences.editDeviceDebugPref();
      assert.deepEqual(preferences.prefs, {
  ...
  suite('preparePref', function() {
    ...
    test('preparePref', function () {
      var cusPref;
      preferences.editLocalDomainPref = function() {
        cusPref = 'local';
      };
      preferences.editDesktopPref = function() {
        cusPref = 'desktop';
      };
      preferences.editDEBUGPref = function() {
        cusPref = 'debug';
      };
      preferences.editDeviceDebugPref = function() {
        cusPref = 'device';
      };
