...
function execute(options) {
  ...
  (function customizeMaximumImageSize() {
    ...
    let galleryDefaultValue = {
      noCropInPick: false
    };
    let customize = JSON.parse(utils.getDistributionFileContent('camera',
                                                                defaultValue,
                                                                distDir));
    let customizeGallery = JSON.parse(utils.getDistributionFileContent(
                                                            'gallery',
                                                            galleryDefaultValue,
                                                            distDir));
    let content =
    ...
    content +=
      '//\n' +
      '// There are few configs from gallery.json, like:\n' +
      '//   {\n' +
      '//     "noCropInPick": false\n' +
      '//   }\n' +
      '//\n' +
      ...
      'var CONFIG_NO_CROP_TOOL_IN_PICKER = ' +
        (customizeGallery.noCropInPick ? 'true' : 'false') + ';\n';
