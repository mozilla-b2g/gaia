...
suite('conference group ui', function() {
  ...
  suiteSetup(function(done) {
    ...
    loadBodyHTML('/dialer/elements/conference_group_details.html');
    var conferenceGroupDetailsTemplate =
      document.body.querySelector('template');

    loadBodyHTML('/dialer/test/unit/mock_group_call.html');
    ...
    require('/dialer/js/conference_group_ui.js', done);
  });
