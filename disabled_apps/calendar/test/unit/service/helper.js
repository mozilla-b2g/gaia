...
var Helper = {
  ...
  resetExpansionLimit: function() {
    if (!Helper._originalExpansionLimit) {
      IcalRecurExpansion.forEachLimit = Helper._originalExpansionLimit;
    }
  },

  setExpansionLimit: function(newLimit) {
    if (!Helper._originalExpansionLimit) {
      Helper._originalExpansionLimit = IcalRecurExpansion.forEachLimit;
    }

    IcalRecurExpansion.forEachLimit = newLimit;
  }
};
