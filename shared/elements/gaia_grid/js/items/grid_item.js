  ...
  GridItem.prototype = {
    ...
    _displayDecoratedIcon: function(blob, isCachedIcon) {
      ...
      if (isCachedIcon) {
        ...
        var img = new Image();
        img.onload = img.onerror = function onload() {
      ...
      this._compareBlobs(blob, this.detail.decoratedIconBlob, function(equal) {
        if (equal) {
          return;
        }
     ...
     */
    _compareBlobs: function(blob1, blob2, cb) {
