...
window.GaiaHr = (function(win) {
  ...
  var baseurl = window.GaiaHrBaseurl ||
    '/shared/elements/gaia_hr/';

  var stylesheets = [{ url: 'style.css', scoped: true }];
  ...
  return document.registerElement('gaia-hr', { prototype: proto });
})(window);
