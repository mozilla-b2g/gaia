  ...
  */
  ...
  ConfirmDialogHelper.prototype = {
    ...
    _show: function(parent) {
      ...
      title.setAttribute('data-l10n-id', config.title);
      body.setAttribute('data-l10n-id', config.body);
      confirm.setAttribute('data-l10n-id', config.confirm.title);

      if (config.cancel) {
        cancel.setAttribute('data-l10n-id', config.cancel.title);
      }
