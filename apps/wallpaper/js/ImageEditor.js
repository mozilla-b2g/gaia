...
ImageEditor.prototype.createThumbnailFromSource = function(fullSizeImage,
                   sourceRectangle, containerWidth, containerHeight, callback) {
...
ImageEditor.prototype.generateNewPreview = function(callback) {
  var self = this;
  this.scale = this.createThumbnailFromSource(this.original,
