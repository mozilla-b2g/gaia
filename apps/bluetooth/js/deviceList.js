...
navigator.mozL10n.ready(function deviceList() {
  ...
  gDeviceList = (function deviceList() {
    ...
    function setOnDeviceSelectedHandler(callback) {
      if (callback) {
        onDeviceSelectedHandler = callback;
      }
    }

    function setOnExitBtnClickedHandler(callback) {
      if (callback) {
        onExitBtnClickedHandler = callback;
      }
    }
    ...
    return {
      ...
      setOnDeviceSelectedHandler: setOnDeviceSelectedHandler,
      setOnExitBtnClickedHandler: setOnExitBtnClickedHandler,
