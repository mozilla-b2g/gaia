...
(function(exports) {
  ...
  UpdateManager.SUB_MODULE = [
    'SystemUpdatable'
  ];
  UpdateManager.IMPORTS = [
    'js/updatable.js'
  ];
  System.create(UpdateManager, {},
  {
    _mgmt: null,
    _downloading: false,
    ...
    oninstall: function um_oninstall(evt) {
      ...
      var updatableApp = new AppUpdatable(app, this);
    },
    ...
    view: function() {
      return '<div id="update-manager-toaster" ' +
              'data-z-index-level="notification-toaster" ' +
        ...
        '<section>' +
          '<h1 data-l10n-id="downloadUpdatesViaDataConnection"></h1>' +
          '<p data-l10n-id="downloadUpdatesViaDataConnectionMessage"></p>' +
        '</section>' +
        '<menu>' +
