      ...
      return Promise.all([
        ...
        this.service.request('WallpaperManager:initializeWallpaper',
          this.wallpaper, this.wallpaperValid).then(() => {
            ...
            // XXX: Here we are recoving the failure that
            // lockscreen is not injected into system.
            if (this.service.query('LockScreenLauncher.launched')) {
              this.debug('transfer passcode to submodules..');
              return Promise.all([
                this.service.request('setPassCodeEnabled',
