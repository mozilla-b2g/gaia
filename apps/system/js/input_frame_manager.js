...
(function(exports) {
  ...
  var InputFrameManager = function(keyboardManager) {
     ...
     * This is a two-level map, from keyboard manifestURL to path_without_hash
     * to an input window. By this structure we fullfill the need to reuse
     * an InputWindows for the same (manifestURL, path_without_hash) of layouts
     * as said above.
     *
     * {
  ...
  function ifm_extractLayoutConfigs(layout){
    ...
    // XXX: change to system2 pattern for "window.applications"?
