/* global SIMSlotManager, System */

'use strict';

(function(exports) {
  var SimLockDialog = function() {};
  SimLockDialog.SUB_MODULE = [
    'SimLockSystemDialog'
  ];
  System.create(SimLockDialog, {}, {
    name: 'SimLockDialog',
    _currentSlot: null,
    ...
    initElements: function spl_initElements() {
      ...
      this.dialogTitle =
        document.querySelector('#simpin-dialog gaia-header h1');
      this.dialogDone =
     ...
     *                   Optional function called when dialog is closed.
  ...
  exports.SimLockDialog = SimLockDialog;
}(window));
