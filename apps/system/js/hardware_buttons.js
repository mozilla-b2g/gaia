...
//   volumedown+sleep volume down and sleep pressed at same time (used for
//                    screenshots)
//
...
(function() {
  ...
  // We can fire sleep, holdsleep, or volumedown+sleep events from this state
  var sleepState = {
    timer: null,
    enter: function() {
      this.timer = setTimeout(function() {
  ...
  // volume down buttons.
  // We can fire volumeup, volumedown and volumedown+sleep events from this
  // state.
  var volumeState = {
    direction: null,
    timer: null,
