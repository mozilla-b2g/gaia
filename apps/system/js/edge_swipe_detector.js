...
(function(exports) {
  ...
  System.create(EdgeSwipeDetector, {}, {
    name: 'EdgeSwipeDetector',
    containerElement: document.getElementById('screen'),
    view: function() {
      return '<div id="left-panel" class="gesture-panel disabled" data-z-index-level="gesture-panel"></div>' +
