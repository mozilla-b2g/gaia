...
(function(exports) {
  ...
  /**
   * Fire a request to lock the lockscreen. It's a wrappered method that
   * would ease the headache of create a request object manually.
   *
   * @this {LockScreenBasicWidget}
   * @memberof LockScreenBasicWidget
   */
  LockScreenBasicWidget.prototype.requestLock =
  function lsbw_requestLock() {
    this.request('lock');
  };

  /**
   * Fire a request to unlock the lockscreen. It's a wrappered method that
   * would ease the headache of create a request object manually.
   *
   * @this {LockScreenBasicWidget}
   * @memberof LockScreenBasicWidget
