...
(function(exports) {
  ...
  SoftwareButtonManager.prototype = {
    ...
    _updateButtonRect: function() {
      ...
      var button;
      if (AppWindowManager.getActiveApp().isFullScreenLayout()) {
    ...
    handleEvent: function(evt) {
      switch (evt.type) {
        ...
        case 'mozorientationchange':
          ...
          this.fullscreenLayoutElement.classList.add('no-transition');
          break;
        case 'orientationchange':
          this.element.classList.remove('no-transition');
          this.fullscreenLayoutElement.classList.remove('no-transition');
          break;
      }
    },
