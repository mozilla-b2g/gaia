...
var PowerSaveHandler = (function PowerSaveHandler() {
  ...
  function hidePowerSavingNotification() {
    if (!this._powerSaveNotification) {
      return;
    }

    this._powerSaveNotification.close();
  }
  ...
  function onBatteryChange() {
    ...
    if (battery.charging) {
      PowerSaveHandler.hidePowerSavingNotification();
      ...
      function getThreshold(value) {
        ...
        if (battery.level <= value && !_powerSaveEnabled) {
          ...
          if (!_powerSaveEnabledLock) {
            PowerSaveHandler.showPowerSavingNotification();
