...
/* global LockScreenStateLogger, LockScreenEventQueue */
...
(function(exports) {
  ...
  function lssm_start(lockScreen) {
    ...
    this.equeue = (new LockScreenEventQueue())
      .start(this.configs.listenEvents, this.handleEvent.bind(this));
    this.setupRules();
    return this;
  };
  ...
  function lssm_handleEvent(evt) {
    ...
    switch(evt.type) {
      ...
      case 'lockscreen-keypad-input':
        this.onKeypadInput(evt.detail.key);
        break;
    }
  };
