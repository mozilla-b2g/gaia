...
(function(exports) {
  ...
  System.create(NotificationScreen, {}, {
    ...
    '_observer_lockscreen.notifications-preview.enabled': function(value) {
      this.lockscreenPreview = value;
    },
    '_observe_audio.volume.notification': function(value) {
      this.silent = (value == 0);
    },
    '_observe_vibration.enabled': function(value) {
      this.vibrates = value;
    },
    '_observe_notifications.resend': function(value) {
    ...
    view: function() {
      '<div id="notification-toaster" data-z-index-level="notification-toaster" ' +
        'role="link" aria-live="assertive" aria-atomic="true">' +
        '<img id="toaster-icon" role="presentation"/>' +
