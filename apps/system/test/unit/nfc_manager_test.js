...
suite('Nfc Manager Functions', function() {
  ...
  suite('_changeHardwareState', function() {
    ...
    suite('DOM request handlers call proper methods.', function() {
      var fakeDOMRequest;
      ...
      setup(function() {
        fakeDOMRequest = new MockDOMRequest();
        var returnRequest = () => fakeDOMRequest;
