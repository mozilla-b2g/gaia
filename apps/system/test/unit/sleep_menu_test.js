...
/* global MocksHelper */
/* global MockL10n */
/* global MockMozMobileConnections */
/* global MockMozPower */
/* global SleepMenu */

require('/shared/test/unit/mocks/mock_l10n.js');
requireApp('system/test/unit/mock_navigator_moz_power.js');
requireApp('system/test/unit/mock_navigator_moz_mobile_connections.js');
...
suite('system/SleepMenu', function() {
  ...
  test('generateItems w/o mozMobileConnections', function() {
    var items = subject.generateItems();
