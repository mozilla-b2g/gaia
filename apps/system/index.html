...
<html>
  <head>
    ...
    <script defer src="js/power_save.js"></script>
    <script defer src="js/battery_overlay.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="style/chrome/chrome.css">
    <link rel="stylesheet" href="shared/elements/gaia_overflow_menu/style/external.css">
    <!--
    ...
    <link rel="stylesheet" type="text/css" href="shared/style/object_menu.css">

    <!-- Include shared web components -->
    <link rel="stylesheet" type="text/css" href="shared/elements/gaia_progress/style/external.css">
    ...
    <link rel="resource" type="audio/ogg" href="shared/resources/media/ringtones/ringer_firefox.opus"/>
    <link rel="resource" type="audio/ogg" href="shared/resources/media/notifications/notifier_firefox.opus"/>
    -->
    ...
    <script defer src="js/base_module.js"></script>
    <script defer src="js/core.js"></script>

    <!-- wake lock managers, used by ScreenManager/Wifi/CpuManager -->
    <script defer src="js/wake_lock_manager.js"></script>

    <script defer src="js/cpu_manager.js"></script>
    ...
    <script defer src="js/browser_settings.js"></script>
    <script defer src="js/bootstrap.js"></script>
    <script defer src="js/screenshot.js"></script>
    <script defer src="js/async_semaphore.js"></script>
    <script defer src="js/sound_manager.js"></script>
    <script defer src="js/source_view.js"></script>
    <script defer src="js/browser_key_event_manager.js"></script>
    ...
    <script defer src="js/app_migrator.js"></script>
    ...
    <script defer src="js/accessibility_quicknav_menu.js"></script>
    ...
    <!-- Keyboard -->
    <script defer src="js/ime_switcher.js"></script>
    <script defer src="js/input_window_manager.js"></script>
    <script defer src="js/input_layouts.js"></script>
    ...
    <!-- Software button -->
    <link rel="stylesheet" type="text/css" href="style/software_button_manager/software_button_manager.css">
    <script defer src="js/software_button_manager.js"></script>
    ...
    <!-- Basket newsletter -->
    <script defer src="/shared/js/basket_client.js"></script>
    <script defer src="js/newsletter_manager.js"></script>

    <!-- ICC/STK -->
    <!-- This depends on ftu_launcher.js, please load it in order ;) -->
    <link rel="stylesheet" type="text/css" href="style/icc.css">
    <script defer src="js/icc_events.js"></script>
    <script defer src="js/icc_worker.js"></script>
    <script defer src="js/icc.js"></script>

    <!-- LockScreen -->
    <script defer src="js/lockscreen_agent.js"></script>
    ...
    <script defer src="js/lockscreen_passcode_validator.js"></script>
    <script defer src="js/lockscreen_notification_builder.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="style/authentication_dialog.css">
    ...
    <script defer src="js/value_selector/trusted_ui_value_selector.js"></script>
    ...
    <!-- Media Playback -->
    <script defer src="js/media_playback.js"></script>
    <link rel="stylesheet" type="text/css" href="style/media_playback/media_playback.css">
    ...
    <script defer src="js/download/download_manager.js"></script>
    <!--
      <script src="shared/js/download/download_helper.js"></script>
      <script src="shared/js/download/download_ui.js"></script>
      <script src="shared/js/download/download_formatter.js"></script>
      <script src="shared/js/download/download_store.js"></script>
    -->

    <!-- Nfc -->
    <script defer src="js/ndef_utils.js"></script>
    <script defer src="js/nfc_handover_manager.js"></script>
    <script defer src="js/nfc_manager.js"></script>
    <script defer src="js/nfc_handler.js"></script>

    <!-- Cards View -->
    <link rel="stylesheet" type="text/css" href="style/cards_view/cards_view.css">
    <script defer src="js/cards_helper.js"></script>
    ...
    <!-- Media Recording -->
    <script defer src="js/media_recording.js"></script>
    <link rel="stylesheet" type="text/css" href="style/media_recording/media_recording.css">
    ...
    <link rel="localization" href="locales/system.{locale}.properties">
    <link rel="localization" href="locales/accessibility.{locale}.properties">
    ...
    <script defer src="js/homescreen_window_manager.js"></script>
    <script defer src="js/activity_window.js"></script>
    <script defer src="js/activity_window_manager.js"></script>
    <script defer src="js/app_window_factory.js"></script>
    <script defer src="js/attention_window.js"></script>
    <script defer src="js/callscreen_window.js"></script>
    <script defer src="js/dialer_agent.js"></script>
    <script defer src="js/attention_indicator.js"></script>
    <script defer src="js/attention_window_manager.js"></script>
    ...
    <script defer src="js/system_nfc_connect_dialog.js"></script>
    <script defer src="js/fxa_dialog.js"></script>
    <script defer src="js/lockscreen_window.js"></script>
    <script defer src="js/lockscreen_input_window.js"></script>
    <script defer src="js/lockscreen_window_manager.js"></script>
    ...
    <script defer src="js/search_window.js"></script>
    <script defer src="shared/js/url_helper.js"></script>
    <link rel="stylesheet" type="text/css" href="style/rocketbar/rocketbar.css">
    <!-- <script defer src="shared/js/icons_helper.js"></script> -->

    <!-- PIN Unlocking -->
    <link rel="stylesheet" type="text/css" href="style/simcard.css">

    <!-- Bluetooth Connect via NFC -->
    <link rel="stylesheet" type="text/css" href="style/nfcconnect.css">
    ...
    <!-- Mobile ID -->
    <link rel="stylesheet" type="text/css" href="style/mobileid/mobileid.css">
    <script defer src="js/mobileid_manager.js"></script>
    <script defer src="js/mobileid_dialog.js"></script>
  </head>
  ...
  <body class="theme-settings" role="application">
    <div id="screen" aria-hidden="true">
      ...
      <div id="statusbar" data-z-index-level="statusbar">
        ...
        <div id="statusbar-icons">
          <div id="statusbar-maximized-wrapper">
            <div id="statusbar-maximized" class="statusbar" role="group" data-l10n-id="statusbar" aria-describedby="ambient-indicator">
              <!-- Carrier & date label -->
              ...
              <div id="statusbar-debugging" data-icon="bug" class="sb-icon sb-icon-debugging" hidden role="listitem"></div>
          ...
          <div id="utility-tray-notifications" data-l10n-id="utilityTray" role="dialog" aria-label="Utility tray" data-z-index-level="utility-tray-notifications">
            ...
            <div id="utility-tray-footer">
              ...
              <div id="quick-settings" role="toolbar">
                <li>
                  <ul><a href="#" id="quick-settings-wifi" class="icon bb-button" data-icon="wifi-4" data-enabled="false" role="button"></a></ul>
                  <ul><a href="#" id="quick-settings-airplane-mode" class="icon bb-button" data-icon="airplane" data-enabled="false" role="button"></a></ul>
                  <ul><a href="#" id="quick-settings-bluetooth" class="icon bb-button" data-icon="bluetooth" data-enabled="false" role="button"></a></ul>
                  <ul><a href="#" id="quick-settings-data" class="icon bb-button" data-icon="data" data-enabled="false" role="button"></a></ul>
                  <ul><a href="#" id="quick-settings-full-app" class="icon bb-button" data-icon="settings" data-enabled="false" role="button" data-l10n-id="settingsButton"></a></ul>
                </li>
              </div>
            </div>
          </div>
      ...
      <!-- XXX: Before we can make LockScree as a iframe or app, we need this to split LockScreen and System part in this way (Bug 1057198) -->
      ...
      <div id="dialog-overlay" data-z-index-level="dialog-overlay">
          ...
          <div id="trustedui-inner">
            ...
            <div id="trustedui-frame-container">
              <div id="trustedui-error-dialog" role="dialog" class="generic-dialog">
                <div class="inner">
                  <h3 id="trustedui-error-title">Error</h3>
                  <p>
                  <span id="trustedui-error-message">The app has encountered an error.</span>
                  </p>
                </div>
                <menu data-items="1">
        ...
        <!-- Mobile ID -->
        <!-- <div id="mobileid-dialog"></div> Add the dialog via SystemDialog dynamically. -->
        ...
        <div id="modal-dialog">
          ...
          <div id="modal-dialog-confirm" role="dialog" class="generic-dialog" tabindex="-1">
            <div class="modal-dialog-message-container inner">
          ...
          <div id="modal-dialog-prompt" role="dialog" class="generic-dialog" tabindex="-1">
            <div class="modal-dialog-message-container inner">
          ...
          <div id="modal-dialog-select-one" role="dialog" class="generic-dialog" tabindex="-1">
            <div class="modal-dialog-message-container inner">
      ...
      <div id="value-selector-groupoption-template" hidden>
      <!--
      <li role="subheader">
      ...
      <div id="device-list-item-tmpl" class="hide">
      <!--
      ...
      <form id="updates-download-dialog" data-type="confirm" role="dialog"
            ...
            data-data-connection-inline-warning="false" class="generic-dialog">
        <section>
          <h1>
            Updates
          </h1>
      ...
      <form id="updates-viaDataConnection-dialog" data-type="confirm" role="dialog" data-z-index-level="updates-viaDataConnection-dialog" class="generic-dialog">
        <section>
          <h1 data-l10n-id="downloadUpdatesViaDataConnection">
            Download updates via data connection?
          </h1>
          <p data-l10n-id="downloadUpdatesViaDataConnectionMessage3">
      ...
      <div id="emergency-callback-toaster" data-z-index-level="notification-toaster" hidden role="link" aria-live="assertive" aria-atomic="true">
        <div class="icon">
        </div>
      ...
      <!-- keyboard -->
      <div id="keyboards" data-z-index-level="keyboards"></div>

      <!-- template for IME Menu. -->
      <div id="ime-menu-template" hidden>
        <!--
        <form role="dialog" data-type="value-selector" class="ime-menu value-selector-container" data-z-index-level="action-menu">
          ...
          <menu class="ime-menu-button-container">
            <button class="ime-menu-button" data-type="cancel" data-action="cancel" data-l10n-id="cancel">${cancelLabel}</button>
          </menu>
        </div>
        -->
      </div> <!-- end of template for IME Menu. -->

      <!-- template for each IME item. -->
      <div id="ime-menu-item-template" hidden>
        <!--
        ...
        -->
      </div> <!-- end of template for each IME item. -->
      ...
      <!-- icc / stk -->
      <div id="icc-view" class="generic-dialog" data-z-index-level="icc-view" role="dialog">
        <section role="region" class="skin-organic" id="icc-alert">
          <gaia-header>
            <h1 id="icc-alert-maintitle">STK Message</h1>
          </gaia-header>
          <gaia-subheader skin="organic"><span id="icc-alert-subtitle"></span></gaia-subheader>
          <p id="icc-alert-msg"></p>
          <menu>
            <button type="button" data-l10n-id="close" id="icc-alert-btn" class="recommend full">Close</button>
          </menu>
        </section>
        <section role="region" class="skin-organic" id="icc-confirm">
          <gaia-header>
            <a href="#"><span class="icon icon-back" id="icc-confirm-btn_back">back</span></a>
            <h1 id="icc-confirm-maintitle">STK Query</h1>
          </gaia-header>
          <gaia-subheader><span id="icc-confirm-subtitle"></span></gaia-subheader>
          <p id="icc-confirm-msg"></p>
          <menu data-items="2">
            <button type="button" data-l10n-id="close" id="icc-confirm-btn_close">Close</button>
            <button type="button" data-l10n-id="ok" id="icc-confirm-btn" class="recommend">OK</button>
          </menu>
        </section>
        <section role="region" class="skin-organic" id="icc-asyncconfirm">
          <gaia-header>
            <h1 id="icc-asyncconfirm-maintitle">STK Query</h1>
          </gaia-header>
          <gaia-subheader skin="organic">
            <span id="icc-asyncconfirm-subtitle"></span>
          </gaia-subheader>
          <p id="icc-asyncconfirm-msg"></p>
          <menu data-items="2">
            <button type="button" data-l10n-id="no" id="icc-asyncconfirm-btn-no">No</button>
            <button type="button" data-l10n-id="yes" id="icc-asyncconfirm-btn-yes" class="recommend">Yes</button>
          </menu>
        </section>
        <section role="region" class="skin-organic" id="icc-input">
          <gaia-header id="icc-input-header" action="back">
            <h1 id="icc-input-maintitle">STK Query</h1>
            <button type="button" data-l10n-id="help" id="icc-input-btn_help">Help</button>
          </gaia-header>
          <gaia-subheader skin="organic"><span id="icc-input-subtitle"></span></gaia-subheader>
          <form>
            <p id="icc-input-msg"></p>
            <input id="icc-input-box" required="" type="text" dir="auto"></input>
          </form>
          <menu>
            <button type="button" data-l10n-id="close" id="icc-input-btn_close">Close</button>
            <span class="yesnodisabled">
              <button type="button" data-l10n-id="ok" id="icc-input-btn" class="recommend">OK</button>
            </span>
            <span class="yesnoenabled">
              <button type="button" data-l10n-id="no" id="icc-input-btn_no">No</button>
              <button type="button" data-l10n-id="yes" id="icc-input-btn_yes" class="recommend">Yes</button>
            </span>
          </menu>
        </section>
      </div>
      ...
      <div id="text-selection-dialog-root" data-z-index-level="text-selection-dialog"></div>

      <div id="software-buttons" data-z-index-level="software-buttons">
        <button id="software-home-button" data-l10n-id="softwareHomeButton"></button>
      </div>
      <button id="fullscreen-software-home-button" data-z-index-level="fullscreen-software-home-button"></button>
      <div id="software-buttons-fullscreen-layout" data-z-index-level="fullscreen-layout-software-home-button">
        <button id="fullscreen-layout-software-home-button" data-z-index-level="fullscreen-layout-software-home-button"></button>
      </div>

      <div id="top-panel" class="gesture-panel" data-z-index-level="gesture-panel"></div>
