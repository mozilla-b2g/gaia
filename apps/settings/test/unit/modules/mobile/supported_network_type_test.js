...
suite('NetworkType', function() {
  var SupportedNetworkTypeHelper;

  suiteSetup(function(done) {
    var modules = [
      'modules/mobile/supported_network_type'
    ];
    var maps = {};

    testRequire(modules, maps, function(module) {
      SupportedNetworkTypeHelper = module.SupportedNetworkTypeHelper;
      done();
    });
  });
      ...
      suite('l10nIdForType()', function() {
        ...
        test('evdo, cdma', function() {
          ...
          assert.equal(helper.l10nIdForType('cdma/evdo'),
            'operator-networkType-auto');
          assert.equal(helper.l10nIdForType('cdma'),
