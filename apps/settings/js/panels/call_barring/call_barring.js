...
define(function(require) {
  ...
  var ChangePasscodeScreen = require('panels/call_barring/cb_change_passcode');
  ...
  var CallBarring = function() {
    ...
    var _mobileConnection = null,
        ...
        _taskScheduler = null,
        _passcodeScreen = null,
        _changePasscodeScreen = null;
    ...
    function _launchPasscodeChange() {
      var toast = null;
      _changePasscodeScreen.launch().then(
    ...
    function _initCallBarring(options) {
      ...
      _passcodeScreen = InputPasscodeScreen();
      _changePasscodeScreen = ChangePasscodeScreen();
    ...
    return {
      ...
      refresh: _updateCallBarringSubpanels
    };
  };
