define(function(require) {
  ...
  var CallIccHandler = (function() {
    ...
    function ihfcs_init() {
      ...
      // Disable the call settings from the ICC card not being the active one
    ...
    /**
     * Helper function. Return the index of the ICC card given the ICC code in
     * the ICC card.
     *
    ...
    /**
     * Helper function. Return the mozMobileConnection for the ICC card given
     * the ICC code in the ICC card.
     *
     * @param {String} iccId The iccId code form the ICC card.
     *
