...
(function() {
  ...
  function PhoneLockPasscode() {
    this.init();
    SettingsPanel.apply(this, arguments);
  }

  PhoneLockPasscode.prototype = {
     ...
     */
    get MODE() {
      return this.passcodePanel.dataset.mode;
    },
    ...
    render: function(config) {
      this.passcodePanel.dataset.mode = config.mode;
    ...
    changeMode: function pl_changeMode(newMode) {
      this.passcodePanel.dataset.mode = newMode;
    },
    ...
    backToPhoneLock: function pl_backToPhoneLock() {
      ...
      Settings.changePanel('phoneLock');
    }
  };

  Settings.definePanel('phoneLock-passcode', PhoneLockPasscode);
}());
