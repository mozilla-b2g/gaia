...
var Browser = {
  ...
  saveMedia: function browser_saveMedia(url, type) {
    ...
    */
    ...
    // Save the file to device storage. The system download manager will take
    // take care of everything else for us! Yay!
    downloadManager.download(url, { targetFilename: name });
  },
