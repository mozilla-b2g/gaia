...
navigator.mozL10n.once(function startup() {
  ...
  function finishDBInitialization() {
    ...
    var firstReadyEventReceived = false;
    ...
    photodb.onready = function() {
      ...
      // If this is not the first time we've been called, it means we were
      // unavailble and are now available again. The files on the sdcard
      // may have changed, and we need to scan again.
      if (firstReadyEventReceived) {
        photodb.scan();
      }
      firstReadyEventReceived = true;
    };
