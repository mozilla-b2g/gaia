...
function onTouchEnd(evt) {
  ...
  handleTouches(evt, function handleTouchEnd(touch, touchId) {
    ...
    endPress(touchKeys[touchId], touch, touchId);
    delete touchKeys[touchId];
  });
}
...
function movePress(target, coords, touchId) {
  ...
  var oldTarget = touchEventsPresent ? touchKeys[touchId] : currentKey;
  ...
  if (target.parentNode !== IMERender.menu && !inMenuLockedArea(coords))
    hideAlternatives();
