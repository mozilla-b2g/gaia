...
return [
  ...
  require('./setup_account_error_mixin'),
  {
    onArgs: function(args) {
      ...
      composite.socket.addEventListener(
        'change', this.onChangeCompositeSocket.bind(this));
      smtp.socket.addEventListener(
