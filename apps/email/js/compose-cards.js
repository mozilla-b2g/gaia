...
function ComposeCard(domNode, mode, args) {
  ...
  // uplifting note: commenting this part in v1.0.1 because we don't support
  // this in this version. Commenting instead of removing so that future
  // uplifters have some context in case of conflicts.
  /*
