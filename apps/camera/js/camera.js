  ...
  setPreviewSize: function(camera) {
    ...
    if (validPreviewsLength) {
      ...
      for (var i = 0; i < validPreviewsLength; i++) {
        ...
        // Calculate distance of screenSize to previewSize
        // Skip Math.pow(n, 0.5) as we only care their relative difference.
        validPreviews[i].diff = widthDiff * widthDiff + heightDiff * heightDiff;
      }
