...
BatteryController.prototype.restoreScreenTimeout = function() {
  ...
  if (this.cachedScreenTimeout === undefined) { return; }
...
BatteryController.prototype.updateScreenTimeout = function() {
  if (this.app.hidden || this.powerSaveScreenTimeout === undefined) {
    return;
  }

  if (this.powerSave) {
    if (this.cachedScreenTimeout) !== undefined || this.cachingScreenTimeout) {
      return;
    }
