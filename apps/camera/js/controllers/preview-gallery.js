...
PreviewGalleryController.prototype.bindEvents = function() {
  ...
  this.previewGallery.on('itemChange', this.onItemChange);
...
/**
 * To Do: Image Swipe Transition like gallery
 */
PreviewGalleryController.prototype.onItemChange = function(e) {
