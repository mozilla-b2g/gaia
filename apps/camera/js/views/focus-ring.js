...
module.exports = View.extend({
  ...
  changePostion: function(position) {
    ...
    this.els.focus.style.left = position.x + 'px';
    this.els.focus.style.top = position.y + 'px';
  },
  ...
  setMaxID: function(mainFace) {
    ...
    this.els.focus.style.transform = 'translate('+ mainFace.pointY + 'px, ' + mainFace.pointX +'px)';
  },
