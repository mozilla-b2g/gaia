...
suite('utils/camera-utils', function() {
  ...
  suite('scaleSizeToFitViewport', function() {
    ...
    test('Should scale image size to *FIT* viewport preserving aspect ratio', function() {
  ...
  suite('scaleSizeToFillViewport', function() {
    ...
    test('Should scale image size to *FILL* viewport preserving aspect ratio', function() {
      var viewportSize, imageSize, outputSize;
  ...
  suite('selectOptimalPreviewSize', function() {
    ...
    test('Should select optimal preview size to *FILL* viewport preserving aspect ratio', function() {
      ...
      optimalPreviewSize = CameraUtils.selectOptimalPreviewSize(viewportSize, previewSizes);
