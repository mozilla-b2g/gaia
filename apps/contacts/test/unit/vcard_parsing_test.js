...
requireApp('contacts/test/unit/mock_contacts_match.js');
requireApp('contacts/test/unit/' +
...
requireApp('contacts/test/unit/import/mock_rest.js');
requireApp('contacts/test/unit/base64_photo.js');
...
function initializeVCFReader(filename, cb) {
  ...
  oReq.open(
    'get', '/apps/contacts/test/unit/vcards/' + filename, true);
  oReq.send();
