...
requireApp('contacts/test/unit/mock_contacts_list_obj.js');
requireApp('contacts/test/unit/mock_cookie.js');
requireApp('contacts/test/unit/mock_datastore_migrator.js');
requireApp('contacts/test/unit/mock_event_listeners.js');
requireApp('contacts/test/unit/mock_navigation.js');
requireApp('contacts/test/unit/mock_activities.js');
requireApp('contacts/test/unit/mock_sms_integration.js');
requireApp('contacts/test/unit/mock_contacts_details.js');
requireApp('contacts/test/unit/mock_contacts_nfc.js');
requireApp('contacts/test/unit/mock_contacts_search.js');
requireApp('contacts/test/unit/mock_contacts_settings.js');
...
suite('Contacts', function() {
  ...
  suiteSetup(function(done) {
    ...
    requireApp('contacts/js/utilities/performance_helper.js');
    requireApp('contacts/js/contacts.js', done);
  });
  ...
  suite('Async scripts loading', function() {
    ...
    test('> loading scripts with nfc enabled', function() {
      ...
      sinon.assert.called(window.dispatchEvent);
      assert.isNotNull(navigator.mozContacts.oncontactchange);
      assert.isTrue(lastParams.indexOf('/js/nfc.js') > -1);
