...
requireApp('contacts/test/unit/mock_contacts_index.html.js');

requireApp('contacts/test/unit/mock_navigation.js');
requireApp('contacts/test/unit/mock_contacts.js');
requireApp('contacts/test/unit/mock_asyncstorage.js');
requireApp('contacts/test/unit/mock_fb.js');
requireApp('contacts/test/unit/mock_wakelock.js');
requireApp('contacts/test/unit/mock_sdcard.js');
requireApp('contacts/test/unit/mock_l10n.js');
requireApp('contacts/test/unit/mock_vcard_parser.js');
requireApp('contacts/test/unit/mock_event_listeners.js');
requireApp('contacts/test/unit/mock_sim_importer.js');

requireApp('communications/dialer/test/unit/mock_confirm_dialog.js');

requireApp('contacts/js/views/settings.js');
requireApp('contacts/js/utilities/icc_handler.js');
requireApp('contacts/js/utilities/sim_dom_generator.js');
requireApp('contacts/js/navigation.js');
