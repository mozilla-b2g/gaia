...
requireApp('contacts/test/unit/import/mock_import.html.js');
requireApp('contacts/test/unit/mock_asyncstorage.js');
requireApp('contacts/test/unit/mock_search.js');
...
requireApp('contacts/test/unit/import/mock_connector.js');
requireApp(
        'contacts/test/unit/import/mock_imported_contacts.js');
