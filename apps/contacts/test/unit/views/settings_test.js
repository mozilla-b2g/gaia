...
requireApp('contacts/test/unit/mock_get_device_storage.js');
requireApp('contacts/test/unit/mock_sdcard.js');
requireApp('contacts/test/unit/mock_icc_helper.js');
...
requireApp('contacts/js/utilities/normalizer.js');
