...
requireApp('contacts/test/unit/mock_details_dom.js.html');
requireApp(
  'contacts/test/unit/webrtc-client/mock_webrtc_client.js');
...
requireApp('contacts/js/views/details.js');
...
requireApp('contacts/test/unit/mock_extfb.js');
requireApp('contacts/test/unit/mock_activities.js');
requireApp('contacts/test/unit/helper.js');
...
requireApp('contacts/js/tag_optionsstem.js');
