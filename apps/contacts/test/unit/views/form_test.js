...
requireApp('contacts/test/unit/mock_form_dom.js.html');

requireApp('contacts/js/contacts_tag.js');
requireApp('contacts/js/views/form.js');
requireApp('contacts/test/unit/mock_navigation.js');
requireApp('contacts/test/unit/mock_contacts.js');
require('/shared/test/unit/mocks/mock_mozContacts.js');
requireApp('contacts/test/unit/mock_external_services.js');
requireApp('contacts/test/unit/mock_fb.js');
requireApp('contacts/test/unit/mock_contacts_search.js');
requireApp('contacts/test/unit/mock_confirm_dialog.js');
requireApp('contacts/test/unit/mock_image_thumbnail.js');
...
requireApp('contacts/js/tag_options.js');
