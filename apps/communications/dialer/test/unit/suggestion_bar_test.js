...
suite('suggestion Bar', function() {
  ...
  setup(function() {
    ...
    realSimplePhoneMatcher = window.SimplePhoneMatcher;
    window.SimplePhoneMatcher = MockSimplePhoneMatcher;
  ...
  test('#clear suggestions', function() {
    ...
    assert.isTrue(
      domSuggestionBar.querySelector('.avatar').classList.contains('hidden'),
      'should hide avatar');
  });
  ...
  teardown(function() {
    ...
    window.SimplePhoneMatcher = realSimplePhoneMatcher;
