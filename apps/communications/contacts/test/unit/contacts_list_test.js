...
suite('Render contacts list', function() {
  ...
  suite('Select mode', function() {
    ...
    test('enter select mode', function(done) {
      ...
      subject.enterSelectMode(selectActionTitle, null, function onSelectMode() {
        // Check visibility
    ...
    test('exit select mode', function() {
    ...
    test('enter select mode 2nd time', function(done) {
      subject.enterSelectMode('title', null, function onSelectMode() {
