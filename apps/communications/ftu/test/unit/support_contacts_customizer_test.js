...
suite('variant > support contacts customization', function() {
  ...
  test('verify mcc/mnc', function() {
    ...
    assert.equal(VariantManager.mcc_mnc, '001-001');
  });
  ...
  test('load and set support contacts from json', function(done) {
    ...
    // Init the VariantManager. This will trigger the support contacts settings
    // to be updated with the values from our JSON file.
    VariantManager.init();
  });
