...
var ValuePicker = (function() {
  ...
  var currentEvent;      // Use current and last mouse event
  var lastEvent;         // to calculate velocity of dragging.
  var startEvent;        // To record start of dragging.
  var currentSpeed;
  var currentindex = 0;
  var startTop = 0;
  ...
  VP.prototype.setSelectedIndex = function(index) {
    this.updateCurrentIndex(index);
    this.alignIndexToUI();
  };

  VP.prototype.updateCurrentIndex = function(index) {
    index = Math.max(this._lower, index);
    index = Math.min(this._upper, index);
    this._currentIndex = index;
    this.resetActiveState(index);
    return index;
  };
  ...
  VP.prototype.alignIndexToUI = function() {
  ...
  VP.prototype.resetActiveState = function(index) {
