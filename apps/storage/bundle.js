...
DataCache.init = function (blockSize) {
  ...
  this._dataStore = require('./MemoryDataStore');
...
},{"./MemoryDataStore":3,"./Settings":5}],3:[function(require,module,exports){
var MemoryDataStore = {};
...
},{"_process":14,"fs":9}],6:[function(require,module,exports){
(function (Buffer){
...
},{"./Settings":5,"buffer":10,"foco":7}],7:[function(require,module,exports){
(function (){
  var foco = {};
...
udManager.init({
  moduleOpt: {
    JSONPath: './samplefs.json'
  },
  metaCacheModule: require('../helper/MetaCache'),
  dataCacheModule: require('../helper/DataCache'),
  webStorageModule: require('../clouddrive/Sample')
});

window.udManager = udManager;

},{"../clouddrive/Sample":1,"../helper/DataCache":2,"../helper/MetaCache":4,"../helper/udManager":6}],9:[function(require,module,exports){
