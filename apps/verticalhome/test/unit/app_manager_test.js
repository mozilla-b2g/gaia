...
suite('app_manager.js > ', function() {
  ...
  test('Uninstall app', function(done) {
    ...
    window.dispatchEvent(new CustomEvent('uninstall-mozapp', {
      'detail': subject
    }));
  ...
  test('Cancel download', function(done) {
    ...
    window.dispatchEvent(new CustomEvent('cancel-download-mozapp', {
      'detail': subject
    }));
  ...
  test('Resume download', function(done) {
    ...
    window.dispatchEvent(new CustomEvent('resume-download-mozapp', {
      'detail': subject
    }));
