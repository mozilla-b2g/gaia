...
"use strict";var toObject=require("./$.to-object"),toIndex=require("./$.to-index"),toLength=require("./$.to-length");module.exports=[].copyWithin||function(t,e){var o=toObject(this),n=toLength(o.length),r=toIndex(t,n),i=toIndex(e,n),d=arguments[2],u=Math.min((void 0===d?n:toIndex(d,n))-i,n-r),h=1;for(r>i&&i+u>r&&(h=-1,i+=u-1,r+=u-1);u-->0;)i in o?o[r]=o[i]:delete o[r],r+=h,i+=h;return o};

},{"./$.to-index":73,"./$.to-length":76,"./$.to-object":77}],5:[function(require,module,exports){
"use strict";var toObject=require("./$.to-object"),toIndex=require("./$.to-index"),toLength=require("./$.to-length");module.exports=[].fill||function(t){for(var e=toObject(this,!0),o=toLength(e.length),r=toIndex(arguments[1],o),n=arguments[2],i=void 0===n?o:toIndex(n,o);i>r;)e[r++]=t;return e};
...
module.exports=function(r){var t=/./;try{"/./"[r](t)}catch(c){try{return t[require("./$.wks")("match")]=!1,!"/./"[r](t)}catch(c){}}return!0};
...
var $=require("./$"),has=require("./$.has"),toIObject=require("./$.to-iobject");module.exports=function(e){return function(r){for(var t,o=toIObject(r),u=$.getKeys(o),n=u.length,i=0,s=[];n>i;)has(o,t=u[i++])&&s.push(e?[t,o[t]]:o[t]);return s}};
...
"use strict";var $def=require("./$.def"),toLength=require("./$.to-length"),context=require("./$.string-context"),ENDS_WITH="endsWith",$endsWith=""[ENDS_WITH];$def($def.P+$def.F*require("./$.fails-is-regexp")(ENDS_WITH),"String",{endsWith:function(e){var t=context(this,e,ENDS_WITH),n=arguments[1],i=toLength(t.length),r=void 0===n?i:Math.min(toLength(n),i),h=String(e);return $endsWith?$endsWith.call(t,h,r):t.slice(r-h.length,r)===h}});
...
"use strict";var $def=require("./$.def"),context=require("./$.string-context"),INCLUDES="includes";$def($def.P+$def.F*require("./$.fails-is-regexp")(INCLUDES),"String",{includes:function(e){return!!~context(this,e,INCLUDES).indexOf(e,arguments[1])}});
...
"use strict";function quote(e){return'"'+e+'"'}function unquote(e){return e.replace(/^"/,"").replace(/"$/,"")}function _isUndefined(e){return"undefined"==typeof e}function sortObjects(e,t){var r="-"===e[0],n=r?e.slice(1):e,u=r?-1:1;return t.slice().sort(function(e,t){return e[n]&&_isUndefined(t[n])?u:t[n]&&_isUndefined(e[n])?-u:_isUndefined(e[n])&&_isUndefined(t[n])?0:e[n]>t[n]?u:-u})}function filterObjects(e,t){return t.filter(function(t){return Object.keys(e).every(function(r){return t[r]===e[r]})})}function reduceRecords(e,t,r){return sortObjects(t,filterObjects(e,r))}function partition(e,t){return 0>=t?e:e.reduce(function(e,r,n){return 0===n||n%t===0?e.push([r]):e[e.length-1].push(r),e},[])}function isUUID4(e){return RE_UUID.test(e)}function waterfall(e,t){return e.length?e.reduce(function(e,t){return e.then(t)},Promise.resolve(t)):Promise.resolve(t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.quote=quote,exports.unquote=unquote,exports.sortObjects=sortObjects,exports.filterObjects=filterObjects,exports.reduceRecords=reduceRecords,exports.partition=partition,exports.isUUID4=isUUID4,exports.waterfall=waterfall;var RE_UUID=/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
