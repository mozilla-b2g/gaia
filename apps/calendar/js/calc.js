...
exports.formatHour = function(hour) {
  ...
  if (hour === exports.ALLDAY) {
    return l10n.get('hour-allday');
  }

  exports._hourDate.setHours(hour);
  var format = l10n.get('hour-format');
  var result = Calendar.App.dateFormat.localeFormat(exports._hourDate, format);
...
/**
 * exportsulates day of week when starting day is Monday.
 */
...
/**
 * exportsulates day of week when starting day is Sunday.
 */
...
/**
 * exportsulates the difference between
 * two points in hours.
 *
...
/**
 * exportsulates the difference (in days) between 2 dates.
 */
