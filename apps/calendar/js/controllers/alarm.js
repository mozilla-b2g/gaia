Calendar.ns('Controllers').Alarm = (function() {
  ...
  Alarm.prototype = {
    ...
    observe: function() {
      ...
      this._wifiLock = null;
      this.app.syncController.once('sync complete', function() {
    ...
    _resetSyncAlarm: function(triggered) {
      ...
      request.onsuccess = function(e) {
        _this._nextPeriodicSync.alarmId = e.target.result;
        _this._nextPeriodicSync.start = start;
        _this._nextPeriodicSync.end = end;
        _this.settings.set('syncAlarm', _this._nextPeriodicSync)
      };
