...
var UIManager = {
  ...
  domSelectors: [
    ...
    'wifi-join-button',
    'join-hidden-button',
    'wifi-configure-network-form',
    'wifi-ssid',
    'wifi-eap-method',
    'wifi-phase-2-authentication',
    'wifi-user',
    'wifi-password',
    'wifi-server-certificate',
    // Hidden Wifi
    'hidden-wifi-configure-network-form',
    ...
    'hidden-wifi-eap-method',
    'hidden-wifi-phase-2-authentication',
    'hidden-wifi-server-certificate',
    //Date & Time
    'date-configuration',
    'time-configuration',
